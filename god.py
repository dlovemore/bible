...
# >>> fnw=b.Is[42:9].words()
# >>> [sums(w) for w in fnw]
# [(46, 109), (33, 213), (75, 291), (77, 374), (24, 96), (36, 108), (35, 260), (55, 271), (19, 55), (42, 555), (77, 374), (19, 64), (9, 9), (48, 138), (51, 168), (58, 913), (83, 326), (67, 364), (9, 9), (49, 265), (61, 1060), (21, 66), (46, 253)]
# >>> 
# >>> 
# >>> 
# >>> sums('freedom')
...
# >>> 144*22
# 3168
# >>> tell('יא  מֵעֲמַל נַפְשׁוֹ, יִרְאֶה יִשְׂבָּע--בְּדַעְתּוֹ יַצְדִּיק צַדִּיק עַבְדִּי, לָרַבִּים; וַעֲוֺנֹתָם, הוּא יִסְבֹּל.') # Isaiah 53:11
...
# >>> tell('מֵעֲמַל נַפְשׁוֹ, יִרְאֶה יִשְׂבָּע--בְּדַעְתּוֹ יַצְדִּיק צַדִּיק עַבְדִּי, לָרַבִּים; וַעֲוֺנֹתָם, הוּא יִסְבֹּל.',ssum)
...
#     0+13+   52+ 29+21+ 33+     83+21+ 36+   67+ 19+   52+ 7+        92+27+ 36+       96+   52+38+      122+     99+    110+   53+ 39+13+   52+  26+   60+        132 = 1480
# >>> fs(1480)
# [2, 2, 2, 5, 37]
# >>> 40*37
# 1480
...
# 53:11 He shall see of the travail of his soul, and shall be satisfied:  by his knowledge shall  my righteous servant justify many; for he shall bear their iniquities.
#     0+13+  169+110+66+213+    731+66+117+  490+ 55+  169+ 7+       434+702+117+      681+  169+740+      779+    846+   1325+  791+156+13+  169+  98+  312+        771 = 10309
# >>> factors(10309)
# [13, 13, 61]
# >>> p(Isaiah[53])
...
#    0+13+ 43+   51+  52+    91+ 19+  52+       94+ 19+ 46+   52+     48+ 36+        108+ 39+13+ 43+ 44+ 27+ 56+21+ 33+  31+21+ 33+     73+ 39+ 33+          178+21+38+    69+ 43+13+       99 = 1691
# >>> Isaiah[53:8].tell(ssum)
# 53:8 He was taken from prison and from judgment: and who shall declare his generation? for he was cut off out of the land of the living: for the transgression of  my people was he stricken.
#    0+13+601+  276+ 196+   379+ 55+ 196+      616+ 55+568+  169+    138+117+        477+156+13+601+503+ 72+560+66+213+  85+66+213+    505+156+213+          862+66+740+   240+601+13+      477 = 10277
# >>> 
# >>> factors(1691)
# [19, 89]
# >>> 
...
# >>> tell('אֱלֹהִים',osum)
# א ֱ  ל ֹ ה ִ  י  ם
# 1+0+12+0+5+0+10+13 = 41
# >>> tell('אֱלֹהִים',ssum)
# א ֱ  ל ֹ ה ִ  י  ם
# 1+0+30+0+5+0+10+40 = 86
# >>> sums("king")
# (41, 86)
# >>> sums('shiloh')
# (71, 215)
# >>> b/'shiloh'
# Genesis 49:10...Jeremiah 41:5 (31 verses)
# >>> p(_)
