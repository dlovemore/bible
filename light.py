...
#   0+ 19+ 26+   33+ 37+   56+ 7+    56+ 19+   56+ 43+    56 = 408
# >>> _.tell()
# 1:3 And God said, Let there be light: and there was light.
#   0+ 19+ 26+   33+ 37+   56+ 7+    56+ 19+   56+ 43+    56 = 408
# >>> _.tell(ssum)
# 1:3 And God said, Let there be light: and there was light.
#   0+ 55+ 71+  114+235+  308+ 7+   254+ 55+  308+601+   254 = 2262
# >>> 
# >>> sums('there')
# (56, 308)
# >>> sums('be')
...
# >>> b[6:16]
# Genesis 6:16...Revelation 6:16 (32 verses)
# >>> p(_)
...
#   0+        9+ 2+    5+ 2+   4+  3+   4+      7+   4+ 2+  3+     6+    5+ 2+   4+     5+   4+ 2+  3+   4+ 2+     6+  3+   4+    4 = 99
# >>> _.tell()
# 2:1 Therefore we ought to give the more earnest heed to the things which we have heard, lest at any time we should let them slip.
#   0+      100+28+   71+35+  43+ 33+  51+     82+  22+35+ 33+    77+   51+28+  36+    36+  56+21+ 40+  47+28+    79+ 37+  46+   56 = 1171
# >>> 
# >>> 
# >>> 
# >>> b/'divid'/'from'
# Genesis 1:4...Luke 12:52 (14 verses)
# >>> p(_)
# Genesis 1:4 And God saw the light, that it was good: and God divided the light from the darkness.
...
#     0+ 39+  52+       102+   56+   52+ 7+  42+23+ 34+   68+      57+   56+     71+  58+ 19+ 58+     71+    56 = 921
# >>> 
# >>> tell('one house')
# one house
#  34+   68 = 102
...
# Leviticus 13:57...Psalms 103:1 (10 verses)
# >>> p(_)
...
#     0+ 19+  70+  30+  51+  49+ 58+   67+ 33+  33+21+ 34+ 43+    45+ 39+23+ 36+  49+ 43+ 33+   52+      57+ 19+ 36+      105+  33+ 43+     71 = 1192
# >>> _.tell(ssum)
# 10:25 And unto Eber were born two sons: the name of one was Peleg; for in his days was the earth divided; and his brother's name was Joktan.
#     0+ 55+ 610+ 102+ 600+ 202+760+  310+213+  96+66+115+601+   117+156+59+117+ 805+601+213+  304+     435+ 55+117+      555+  96+601+    341 = 8302
# >>> factors(341)
# [11, 31]
...
#     0+29+28+    70+35+   98+23+ 33+  49+  43+35+ 57+        78+23+  28 = 629
# 118:9 It is better to trust in the LORD than to put confidence in princes.
#     0+29+28+    70+35+   98+23+ 33+  49+  43+35+ 57+        78+23+      84 = 685
# >>> b.chapter(629)
# Proverbs 1:1-33 (33 verses)
# >>> 
# >>> 
...
#    0+ 19+  56+28+ 33+    100+  49+ 43+     109+   37+   37+    53+      106 = 670
# >>> tell('PERES')
#  P E  R E  S
# 16+5+18+5+19 = 63
# >>> p(Daniel[5:25]-28)
...
#    0+    63+ 53+     73+28+      57+ 19+   57+35+ 33+   46+ 19+      101 = 584
# >>> 
# >>> 
# >>> 
# >>> int(_)
...
#   0+23+ 33+       81+ 26+     56+ 33+    55+ 19+ 33+    52 = 411
# >>> Psalm[37:]
...
#    0+ 55+ 71+  50+760+  303+    354+213+    398+  254+260+ 425+213+ 705+ 55+213+   330+  254+260+ 425+213+   274+13+  50+213+  491+  191 = 7043
# 1:17 And God set them in the firmament of the heaven  to give light upon the earth,
#    0+ 55+ 71+305+ 253+59+213+      441+66+213+   469+260+ 421+  254+ 480+213+   304 = 4077
# >>> 7043+4077
# 11120
# >>> c
# 299792458
...
# (['earth', 'in', 'the', 'open', 'firmament', 'of', 'heaven.', 'And', 'God'], Genesis 1:20...4:11 (4 verses))
# >>> Genesis[1:20]
# Genesis 1:20 And God said, Let the waters bring forth abundantly the moving creature that hath life, and fowl that may fly above the earth in the open firmament of heaven.
# >>> _.wc()
# 29
