from parle import *
pistr=File(Path(__file__).parent/'pi-digits').text.replace('\n','')
...
# '' '14159265' '58979' '2' '846264' '' '8' '279502884197169' '99' '75105820974944592' '078164062862089986280' '4825' '4211706798214808651' '282' '0664709' '8446095505822' '1725' '594081284811174502841027019' '85211055596446229489549' '0' '819644288109756659' '' '4461284756482' '' '78678' '16527120190914564856692' '460' '48610454' '2664821' '' '9' '60726024914127' '724587006606' '15588174881520920962829254091715' '64' '67892590' '60011' '' '05' '0548820466521' '841469519415116094' '' '057270' '6575959195' '092186117' '819' '261179' '105118548074462' '79962749567' '518857527248912279' '818' '0119491298' '' '67' '' '6244065664' '086021' '94946' '952247' '719070217986094' '7027705' '921717629' '176752' '846748184676694051' '200056812714526' '560827785771' '4275778960917' '6' '717872146844090122495' '4' '0146549585' '7105079227968925892' '5420199561121290219608640' '441815981' '629774771' '09960518707211' '49999998' '729780499510597' '17' '2816096' '18595024459455' '46908' '02642522' '0825' '' '446850' '52619' '118817101000' '1' '78' '87528865875' '' '208' '81420617177669147' '0' '59825' '4904287554687' '115956286' '882' '5' '78759' '7519577818577805' '217122680661' '001927876611195909216420198'
# >>> _@len
# 0 8 5 1 6 0 1 15 2 17 21 4 19 3 7 13 4 27 23 1 18 0 13 0 5 23 3 8 7 0 1 14 12 32 2 8 5 0 2 13 18 0 6 10 9 3 6 15 11 18 3 10 0 2 0 10 6 5 6 15 7 9 6 18 15 12 13 1 21 1 10 19 25 9 9 14 8 15 2 7 14 5 8 4 0 6 5 12 1 2 11 0 3 17 1 5 13 9 3 1 5 16 12 27
# >>> from func import *
# >>> def add1(x,y): return x+y+1
# ... 
# >>> add1//_
# 0 9 15 17 24 25 27 43 46 64 86 91 111 115 123 137 142 170 194 196 215 216 230 231 237 261 265 274 282 283 285 300 313 346 349 358 364 365 368 382 401 402 409 420 430 434 441 457 469 488 492 503 504 507 508 519 526 532 539 555 563 573 580 599 615 628 642 644 666 668 679 699 725 735 745 760 769 785 788 796 811 817 826 831 832 839 845 858 860 863 875 876 880 898 900 906 920 930 934 936 942 959 972 1000
# >>> 
# >>> pistr[:100]
...
# >>> 
# >>> 
# >>> pi=Decimal('3.'+pistr[1:72])
# >>> pi
# Decimal('3.14159265358979323846264338327950288419716939937510582097494459230781640')
# >>> 
# >>> 
# >>> 
# >>> pi/355
# Decimal('0.008849556770675473911162375728')
# >>> _*113
# Decimal('0.9999999150863285519613484573')
# >>> 1-_
# Decimal('8.49136714480386515427E-8')
# >>> 1/_
# Decimal('11776666.61854247437447735855')
## >>> ns(11776666)
## [2, 11, 535303] [1, 5, 44219]
# >>> ns(11776667)
# [7, 23, 193, 379] [4, 9, 44, 75]
# >>> 23*193*379
# 1682381
# >>> 1682381/535303
# 3.1428574097286957
# >>> pi*5353535353
# Decimal('16818627335.71804046207012072')
# >>> pi*53/99
# Decimal('1.681862733739990319581011104')
# >>> 168186273374*99/53
# 314159265358.98114
# >>> φ
# 1.618033988749895
...
# 353299998
# >>> 3532300/pi
# Decimal('1124366.010967003789072856235')
# >>> fr(3532300,1124366)
# Fraction(1766150, 562183)
# >>> _
# Fraction(1766150, 562183)
# >>> _*1.0
# 3.141592684232714
...
# >>> t=Table([['i','around ith digit of \u03c0']]+[[x,'...'+(pistr[x-7:x+7]+'...').replace(str(x),'**'+str(x)+'**')] for x in span(10,1000000) if str(x) in pistr[x-len(str(x)):x+len(str(x))]])
# >>> p(mdtable(t))
# |i|around ith digit of π
# |-|-
# |315|...06606**315**588174...
# |360|...92590**360**011330...
# |384|...66521**384**146951...
# |875|...8865**875**3320838...
# |1614|...600**1614**5249192...
# |9218|...488**9218**6543648...
# |16470|...7048758**16470**32...
# |44899|...5459447**44899**08...
# |47696|...80052**47696**8840...
# |62843|...6320**62843**20656...
# |242424|...3213**242424**2420...
# |247826|...1**247826**0968080...
# |271070|...562510**271070**62...
# |496498|...70807**496498**243...
