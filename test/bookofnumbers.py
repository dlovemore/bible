    ...
    >>> num1515=[('Reuben','Elizur','Shedeur'),
    ... ('Simeon','Shelumiel','Zurishaddai'),
    ... ('Judah','Nahshon','Amminadab'),
    ...
    ... ('Gad','Eliasaph','Deuel'),
    ... ('Naphtali','Ahira','Enan')]
    >>> [count(x) for x,y,z in num1515]
    [65, 75, 44, 78, 101, 70, 80, 68, 19, 51, 12, 81]
    >>> tell('Reuben Simeon Levi Judah Dan Napthali Gad Asher Issachar Zebulun Joseph Benjamin')
    Reuben Simeon Levi Judah Dan Napthali Gad Asher Issachar Zebulun Joseph Benjamin  =
      65     75    48    44   19    81     12   51     78      101     73      68    715
    >>> tell('Dinah')
    D i n  a h =
    4 9 14 1 8 36
    >>> tell('Ephraim Manasseh')
    Ephraim Manasseh  =
       70      80    150
    >>> [count(y) for x,y,z in num1515]
    [91, 104, 79, 84, 29, 68, 60, 31, 72, 50, 71, 37]
    >>> [ssum(y) for x,y,z in num1515]
    [1234, 527, 277, 354, 47, 194, 123, 67, 918, 122, 224, 109]
    >>> tale(_)
    [1234, 1761, 2038, 2392, 2439, 2633, 2756, 2823, 3741, 3863, 4087, 4196]
    >>> pf(4196)
    Counter({2: 2, 1049: 1})
    >>> 
    >>> sum([Numbers[1:i] for i in span(21,43,2)],Sel(b,[]))
    Numbers 1:21,23,25,27,29,31,33,35,37,39,41,43 (12 verses)
    >>> p(_)
    ...
    >>> num12143=[('Reuben',46500), ('Simeon',59300), ('Gad',45650), ('Judah',74600), ('Issachar',54400), ('Zebulun',57400), ('Ephraim',40500), ('Manasseh',32200), ('Benjamin',35400), ('Dan',62700), ('Asher',41500), ('Naphtali',53400)]
    >>> dict(num12143)
    {'Reuben': 46500, 'Simeon': 59300, 'Gad': 45650, 'Judah': 74600, 'Issachar': 54400, 'Zebulun': 57400, 'Ephraim': 40500, 'Manasseh': 32200, 'Benjamin': 35400, 'Dan': 62700, 'Asher': 41500, 'Naphtali': 53400}
    >>> p(sum(_.values()))
    603550
    >>> t=dict(num12143)
    >>> sum(get(t,'Judah','Issachar','Zebulun'))
    186400
    >>> sum(get(t,'Judah','Issachar','Zebulun'))
