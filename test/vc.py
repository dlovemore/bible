...
>>> lmap((lambda x: x+3),[1,2,3])
[4, 5, 6]
>>> Genesis[1:1]
Genesis 1:1 In the beginning God created the heaven and the earth.
>>> Genesis[1:1].v()
'In the beginning God created the heaven and the earth.'
>>> g11=Genesis[1:1].v().split()
>>> g11
['In', 'the', 'beginning', 'God', 'created', 'the', 'heaven', 'and', 'the', 'earth.']
>>> lmap(len,g11)
[2, 3, 9, 3, 7, 3, 6, 3, 3, 6]
>>> lmap(prime,_)
[3, 5, 23, 5, 17, 5, 13, 5, 5, 13]
>>> def f(x): return prime(len(x))
... 
>>> lmap(f,g11)
[3, 5, 23, 5, 17, 5, 13, 5, 5, 13]
>>> f2= compose(len,prime)
>>> f2('abc')
5
>>> lmap(f2,g11)
[3, 5, 23, 5, 17, 5, 13, 5, 5, 13]
>>> 
>>> lmap(compose(len,prime),Genesis[1:1].v().split())
[3, 5, 23, 5, 17, 5, 13, 5, 5, 13]
>>> 
>>> 
>>> 
